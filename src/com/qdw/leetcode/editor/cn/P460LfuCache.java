...
// put(key, value) - 如果键不存在，请设置或插入值。当缓存达到其容量时，则应该在插入新项之前，使最不经常使用的项无效。在此问题中，当存在平局
//（即两个或更多个键具有相同使用频率）时，应该去除 最近 最少使用的键。 
// 
//
...
public class P460LfuCache{
    public static void main(String[] args) {
        LFUCache cache = new P460LfuCache().new LFUCache(2);
        // TO TEST
        cache.put(1, 1);
        cache.put(2, 2);
